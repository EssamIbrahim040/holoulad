...
<div class="container">
    <form action="code.php" class="mt-4"  method="post">
         ...
         <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label"> الطلب</label>
                <input class="form-control" type="text" name="requer" placeholder="ادخل اسم الطلب"><br>
        </div>
        <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">تفاصيل الطلب</label>
                <input class="form-control" type="text" placeholder="ادخل تفاصيل الطلب" name="detail"><br>
        </div>
